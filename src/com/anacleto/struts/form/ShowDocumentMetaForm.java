 ...
 */
public class ShowDocumentMetaForm extends ActionForm {
    ...
    private boolean isPrevNextDocNavigation;
    ...
    /**
     * @param nextRes The nextRes to set.
     */
    ...
    /**
     * @param prevRes The prevRes to set.
     */
    ...
    /**
     * @param atLast The atLast to set.
     */
	...
	public boolean isPrevNextDocNavigation() {
		return isPrevNextDocNavigation;
	}

	public boolean getIsPrevNextDocNavigation() {
		return isPrevNextDocNavigation;
	}

	public void setPrevNextDocNavigation(boolean isPrevNextDocNavigation) {
		this.isPrevNextDocNavigation = isPrevNextDocNavigation;
	}
}